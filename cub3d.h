...
/*   Updated: 2026/05/19 12:51:17 by ramarti2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					check_adjacent_spaces(t_data *data, char **map, int y,
						int x);
...
void				set_up_vectors(t_data *data, t_player *player, t_ray *ray,
						int x);
void				init_sidedists_and_steps(t_ray *ray, t_player *player);
void				calc_line_height(t_data *data, double perp_dist);
void				texture_calculations(t_data *data, t_player *player,
						t_ray *ray, double perp_dist);
